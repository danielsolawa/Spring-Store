...
create table contact (id bigint not null auto_increment, content varchar(255), conversation_id varchar(255), date tinyblob, subject varchar(255), user_id bigint, primary key (id)) ENGINE=InnoDB
